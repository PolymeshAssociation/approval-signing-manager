import { stringToU8a } from '@polkadot/util'; // should be in signing manager types after > 3.4.0
import {
  SignerPayloadJSON,
  SignerPayloadRaw,
  TypeRegistry,
...
import { ApprovalSigner, ApprovalSigningManager } from '../';
import { ApprovalClient } from '../lib/approval-client/approval-client';
import { mockApprovalClient } from '../lib/approval-client/mocks';

jest.mock('../lib/approval-client', () => ({
  // eslint-disable-next-line @typescript-eslint/naming-convention
  ApprovalClient: function () {
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    return require('../lib/approval-client/mocks').mockApprovalClient;
  },
}));
